...
subDom = "other";
if (cd_city.match(/Toronto|Montr|Calgary|Ottawa|Edmonton|Mississauga|Winnipeg|Vancouver|Hamilton|City/)) {
	subDom = "city";
} else if (cd_city.match(/Events/)) {
	subDom = "www";
}
...
if (siteSection == "mainsite") {
	...
	if (subDom == "www") {
		...
		if (ThsBlg_pg == 'mainpage') {
			...
			$('.bd_5139433660953520553 h1 a').html(` <span style="font-size:24px;line-height:1em;"> <span style="font-size:120%;color:#49596f;">Canadiary</span><br><span style="color:red"> </span> Canadian events </span> `); // Change 'sometext' to 'yes'

			$('.bd_5139433660953520553 .container').html(` <style> #wwwmain { display: flex; flex-direction: column; align-items: center; } #wwwmain a { display: block; background: #9cb2ce; color: white; padding: 10px 20px; margin: 5px 0; border-radius: 30px; text-decoration: none; font-size: 24px; min-width: 160px; text-align: center; } </style> <div id="wwwmain" style=""> <a href="https://toronto.canadiary.com">Toronto</a> <a href="https://montreal.canadiary.com">Montreal</a> <a href="https://calgary.canadiary.com">Calgary</a> <a href="https://ottawa.canadiary.com">Ottawa</a> <a href="https://edmonton.canadiary.com">Edmonton</a> <a href="https://mississauga.canadiary.com">Mississauga</a> <a href="https://winnipeg.canadiary.com">Winnipeg</a> <a href="https://vancouver.canadiary.com">Vancouver</a> <a href="https://hamilton.canadiary.com">Hamilton</a> <a href="https://quebeccity.canadiary.com">Quebec City</a> </div> `);
